    ...
    public class Camera2DViewportListener : IViewportEventListener, IMediatorListener
    {
        ...
        public void KeyDown(ViewportEvent e)
        {
            if (e.KeyCode == Keys.Space)
            {
                ...
                if (!Chisel.Settings.View.Camera2DPanRequiresMouseClick)
                {
            ...
            var moveAllowed = DocumentManager.CurrentDocument != null &&
                              (DocumentManager.CurrentDocument.Selection.IsEmpty()
                               || !Chisel.Settings.Select.ArrowKeysNudgeSelection);
            if (moveAllowed)
            {
        ...
        public void MouseMove(ViewportEvent e)
        {
            ...
            {
                Viewport.Cursor = Cursors.SizeAll;
                if (lmouse || mmouse || !Chisel.Settings.View.Camera2DPanRequiresMouseClick)
                {
        ...
        public void MouseWheel(ViewportEvent e)
        {
            ...
            Viewport2D.Zoom *= DMath.Pow(Chisel.Settings.View.ScrollWheelZoomMultiplier, (e.Delta < 0 ? -1 : 1));
        ...
        {
            var space = KeyboardState.IsKeyDown(Keys.Space);
            var req = Chisel.Settings.View.Camera2DPanRequiresMouseClick;
