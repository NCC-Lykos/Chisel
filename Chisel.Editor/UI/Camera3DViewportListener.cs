...
using KeyboardState = Chisel.UI.KeyboardState;
...
namespace Chisel.Editor.UI
{
    public class Camera3DViewportListener : IViewportEventListener, IMediatorListener
    {
        ...
        public void UpdateFrame(FrameInfo frame)
        {
            ...
            var units = Chisel.Settings.View.ForwardSpeed * seconds;
            ...
            if (Chisel.Settings.View.TimeToTopSpeed > 0)
            {
                var downFor = (frame.Milliseconds - _downMillis) / Chisel.Settings.View.TimeToTopSpeed;
        ...
        private void SetFreeLook()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    var req = Chisel.Settings.View.Camera3DPanRequiresMouseClick;
        ...
        private void MouseMoved(ViewportEvent e, int dx, int dy)
        {
            ...
            if (Chisel.Settings.View.InvertX) dx = -dx;
            if (Chisel.Settings.View.InvertY) dy = -dy;
        ...
        public void MouseWheel(ViewportEvent e)
        {
            ...
            Camera.Advance((e.Delta / Math.Abs(e.Delta)) * Chisel.Settings.View.MouseWheelMoveDistance);
        }
