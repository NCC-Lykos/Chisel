...
namespace Chisel.Editor.UI.Sidebar
{
    public class SidebarManager : IMediatorListener
    {
        ...
        public static void Init(DockedPanel container)
        {
            ...
            if (Chisel.Settings.Layout.SidebarWidth <= 10) container.Hidden = true;
            else container.Width = Chisel.Settings.Layout.SidebarWidth;
            container.Resize += (s, e) => Chisel.Settings.Layout.SidebarWidth = container.Hidden ? 0 : container.Width;
        ...
        public static void SaveLayout()
        {
            ...
            Chisel.Settings.Layout.SidebarLayout = serialised;
        }

        private static bool Expanded(string text)
        {
            return Chisel.Settings.Layout.SidebarLayout.Split(';')
                .Select(x => x.Split(':'))
