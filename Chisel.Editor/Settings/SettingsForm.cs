...
namespace Chisel.Editor.Settings
{
    /// <summary>
    ...
    public partial class SettingsForm : Form
    {
        ...
        private void SettingsFormLoad(object sender, EventArgs e)
        {
            ...
            AddSetting(() => Chisel.Settings.Select.SwitchToSelectAfterCreation, "Switch to selection tool after brush creation");
            AddSetting(() => Chisel.Settings.Select.SwitchToSelectAfterEntity, "Switch to selection tool after entity creation");
            AddSetting(() => Chisel.Settings.Select.SelectCreatedBrush, "Automatically select created brush");
            AddSetting(() => Chisel.Settings.Select.SelectCreatedEntity, "Automatically select created entity");
            AddSetting(() => Chisel.Settings.Select.DeselectOthersWhenSelectingCreation, "Deselect other objects when automatically selecting created items");
            AddSetting(() => Chisel.Settings.Select.ResetBrushTypeOnCreation, "Reset to block brush type after creating brush");
            AddSetting(() => Chisel.Settings.Select.KeepVisgroupsWhenCloning, "Keep visgroups when cloning");

            AddHeading("Multiple Files");
            AddSetting(() => Chisel.Settings.View.LoadSession, "Load previously opened files on startup");
            AddSetting(() => Chisel.Settings.View.KeepCameraPositions, "Keep current camera positions when switching between maps");
            AddSetting(() => Chisel.Settings.View.KeepSelectedTool, "Keep current selected tool when switching between maps");

            AddHeading("Compiling");
            AddSetting(() => Chisel.Settings.View.CompileOpenOutput, "Open the output panel on compile start");
            AddSetting(() => Chisel.Settings.View.CompileDefaultAdvanced, "Use advanced compile dialog by default");

            AddHeading("Textures");
            AddSetting(() => Chisel.Settings.Select.ApplyTextureImmediately, "Apply texture immediately after browsing in the texture application tool");

            AddHeading("Rendering (these settings will be applied after Chisel is restarted)");
            AddSetting(() => Chisel.Settings.View.Renderer, "Renderer");
            AddSetting(() => Chisel.Settings.View.DisableWadTransparency, "Disable WAD texture transparency");
            AddSetting(() => Chisel.Settings.View.DisableToolTextureTransparency, "Disable tool texture transparency");
            AddSetting(() => Chisel.Settings.View.GloballyDisableTransparency, "Disable transparent textures globally");
            AddSetting(() => Chisel.Settings.View.DisableModelRendering, "Disable model rendering");
            ...
            AddSetting(() => Chisel.Settings.Select.CenterHandlesActiveViewportOnly, "Render center handles only in active viewport");
            AddSetting(() => Chisel.Settings.Select.CenterHandlesFollowCursor, "Render center handles only near cursor position");
            AddSetting(() => Chisel.Settings.Select.BoxSelectByCenterHandlesOnly, "Selection box selects by center handles only");
            AddSetting(() => Chisel.Settings.Select.ClickSelectByCenterHandlesOnly, "Clicking in 2D view selects by center handles only");

            AddHeading("Interaction");
            AddSetting(() => Chisel.Settings.Select.DoubleClick3DAction, "Action to perform when double-clicking an object in the 3D view");
            AddSetting(() => Chisel.Settings.Select.OpenObjectPropertiesWhenCreatingEntity, "Open object properties when creating an entity");

            AddHeading("2D Vertices");
            AddSetting(() => Chisel.Settings.View.Draw2DVertices, "Render vertices in 2D views");
            AddSetting(() => Chisel.Settings.View.VertexPointSize, 1, 10, "Vertex point size");
            AddSetting(() => Chisel.Settings.View.OverrideVertexColour, "Override vertex colour (defaults to the brush colour)");
            AddSetting(() => Chisel.Settings.View.VertexOverrideColour, "Vertex override colour");

            AddHeading("Selection Box");
            AddSetting(() => Chisel.Settings.Select.AutoSelectBox, "Automatically select when box is drawn");
            AddSetting(() => Chisel.Settings.View.DrawBoxText, "Draw selection box size in the viewport");
            AddSetting(() => Chisel.Settings.View.DrawBoxDashedLines, "Draw selection box with dashed lines");
            AddSetting(() => Chisel.Settings.View.ScrollWheelZoomMultiplier, 1.01m, 10, 2, 0.1m, "Scroll wheel zoom multiplier (default 1.20)");
            AddSetting(() => Chisel.Settings.View.SelectionBoxBackgroundOpacity, 0, 128, "Selection box background opacity");

            AddHeading("Camera");
            AddSetting(() => Chisel.Settings.View.Camera2DPanRequiresMouseClick, "Require mouse click to enable panning in 2D viewports when holding spacebar");
            AddSetting(() => Chisel.Settings.View.Camera3DPanRequiresMouseClick, "Require mouse click to enable free-look in 3D viewports when holding spacebar");

            AddHeading("Undo Stack");
            AddSetting(() => Chisel.Settings.Select.UndoStackSize, 1, 1000, "Undo stack size (caution: setting too high may result in an out of memory crash!)");
            AddSetting(() => Chisel.Settings.Select.SkipSelectionInUndoStack, "Fast-forward selection operations when performing undo/redo (selection, deselection)");
            AddSetting(() => Chisel.Settings.Select.SkipVisibilityInUndoStack, "Fast-forward visibility operations when performing undo/redo (visgroup visibility, quick show/hide)");

            // Integration
            SingleInstanceCheckbox.Checked = Chisel.Settings.View.SingleInstance;

            // 2D Views
            CrosshairCursorIn2DViews.Checked = Chisel.Settings.View.CrosshairCursorIn2DViews;
            DrawEntityNames.Checked = Chisel.Settings.View.DrawEntityNames;
            DrawEntityAngles.Checked = Chisel.Settings.View.DrawEntityAngles; //mxd

            RotationStyle_SnapOnShift.Checked = Chisel.Settings.Select.RotationStyle == RotationStyle.SnapOnShift;
            RotationStyle_SnapOffShift.Checked = Chisel.Settings.Select.RotationStyle == RotationStyle.SnapOffShift;
            RotationStyle_SnapNever.Checked = Chisel.Settings.Select.RotationStyle == RotationStyle.SnapNever;

            SnapStyle_SnapOffAlt.Checked = Chisel.Settings.Select.SnapStyle == SnapStyle.SnapOffAlt;
            SnapStyle_SnapOnAlt.Checked = Chisel.Settings.Select.SnapStyle == SnapStyle.SnapOnAlt;

            ArrowKeysNudgeSelection.Checked = Chisel.Settings.Select.ArrowKeysNudgeSelection;
            NudgeUnits.Value = Chisel.Settings.Select.NudgeUnits;
            NudgeStyle_GridOffCtrl.Checked = Chisel.Settings.Select.NudgeStyle == NudgeStyle.GridOffCtrl;
            NudgeStyle_GridOnCtrl.Checked = Chisel.Settings.Select.NudgeStyle == NudgeStyle.GridOnCtrl;
            ...
            // 3D Views
            ViewportBackgroundColour.BackColor = Chisel.Settings.View.ViewportBackground;
            BackClippingPlaneUpDown.Value = BackClippingPane.Value = Chisel.Settings.View.BackClippingPane;
            ModelRenderDistanceUpDown.Value = ModelRenderDistance.Value = Chisel.Settings.View.ModelRenderDistance;
            DetailRenderDistanceUpDown.Value = DetailRenderDistance.Value = Chisel.Settings.View.DetailRenderDistance;
            BackClippingPaneChanged(null, null);
            ModelRenderDistanceChanged(null, null);
            DetailRenderDistanceChanged(null, null);

            ForwardSpeedUpDown.Value = ForwardSpeed.Value = Chisel.Settings.View.ForwardSpeed;
            ForwardSpeedChanged(null, null);

            TimeToTopSpeed.Value = (int) (Chisel.Settings.View.TimeToTopSpeed / 100);
            TimeToTopSpeedUpDown.Value = Chisel.Settings.View.TimeToTopSpeed / 1000;
            TimeToTopSpeedChanged(null, null);

            InvertMouseX.Checked = Chisel.Settings.View.InvertX;
            InvertMouseY.Checked = Chisel.Settings.View.InvertY;
            MouseWheelMoveDistance.Value = Chisel.Settings.View.MouseWheelMoveDistance;

            CameraFOV.Value = Chisel.Settings.View.CameraFOV;
        ...
        {
            // Integration
            Chisel.Settings.View.SingleInstance = SingleInstanceCheckbox.Checked;

            // 2D Views
            Chisel.Settings.View.CrosshairCursorIn2DViews = CrosshairCursorIn2DViews.Checked;
            Chisel.Settings.View.DrawEntityNames = DrawEntityNames.Checked;
            Chisel.Settings.View.DrawEntityAngles = DrawEntityAngles.Checked; //mxd

            if (RotationStyle_SnapOnShift.Checked) Chisel.Settings.Select.RotationStyle = RotationStyle.SnapOnShift;
            if (RotationStyle_SnapOffShift.Checked) Chisel.Settings.Select.RotationStyle = RotationStyle.SnapOffShift;
            if (RotationStyle_SnapNever.Checked) Chisel.Settings.Select.RotationStyle = RotationStyle.SnapNever;

            if (SnapStyle_SnapOffAlt.Checked) Chisel.Settings.Select.SnapStyle = SnapStyle.SnapOffAlt;
            if (SnapStyle_SnapOnAlt.Checked) Chisel.Settings.Select.SnapStyle = SnapStyle.SnapOnAlt;

            Chisel.Settings.Select.ArrowKeysNudgeSelection = ArrowKeysNudgeSelection.Checked;
            Chisel.Settings.Select.NudgeUnits = NudgeUnits.Value;
            if (NudgeStyle_GridOffCtrl.Checked) Chisel.Settings.Select.NudgeStyle = NudgeStyle.GridOffCtrl;
            if (NudgeStyle_GridOnCtrl.Checked) Chisel.Settings.Select.NudgeStyle = NudgeStyle.GridOnCtrl;
            ...
            // 3D Views
            Chisel.Settings.View.ViewportBackground = ViewportBackgroundColour.BackColor;
            Chisel.Settings.View.BackClippingPane = BackClippingPane.Value;
            Chisel.Settings.View.ModelRenderDistance = ModelRenderDistance.Value;
            Chisel.Settings.View.DetailRenderDistance = DetailRenderDistance.Value;

            Chisel.Settings.View.ForwardSpeed = ForwardSpeed.Value;
            Chisel.Settings.View.TimeToTopSpeed = TimeToTopSpeed.Value * 100m;
            Chisel.Settings.View.InvertX = InvertMouseX.Checked;
            Chisel.Settings.View.InvertY = InvertMouseY.Checked;
            Chisel.Settings.View.MouseWheelMoveDistance = MouseWheelMoveDistance.Value;

            Chisel.Settings.View.CameraFOV = (int) CameraFOV.Value;
