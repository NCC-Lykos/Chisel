...
namespace Chisel.Editor.Tools
{
    public class CordonTool : BaseBoxTool
    {
        ...
        {
            get { return Color.FromArgb(Chisel.Settings.View.SelectionBoxBackgroundOpacity, Color.LightGray); }
        }
        ...
        protected override void Render2D(Chisel.UI.Viewport2D viewport)
        {
        ...
        public override void BoxDrawnConfirm(Chisel.UI.ViewportBase viewport)
        {
            //
        }

        public override void BoxDrawnCancel(Chisel.UI.ViewportBase viewport)
        {
            //
        }
    }
