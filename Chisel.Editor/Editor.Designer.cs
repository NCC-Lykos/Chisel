...
namespace Chisel.Editor
{
    partial class Editor
    {
        ...
        private void InitializeComponent()
        {
            ...
            Chisel.Editor.UI.TableSplitConfiguration tableSplitConfiguration1 = new Chisel.Editor.UI.TableSplitConfiguration();
            ...
            this.DockFill = new Chisel.Editor.UI.DockedPanel();
            this.TableSplitView = new Chisel.Editor.UI.TableSplitControl();
            this.DocumentTabs = new Chisel.Editor.UI.ClosableTabControl();
            this.tabPage1 = new System.Windows.Forms.TabPage();
            this.RightSidebar = new Chisel.Editor.UI.DockedPanel();
            this.DockLeft = new Chisel.Editor.UI.DockedPanel();
            this.DockBottom = new Chisel.Editor.UI.DockedPanel();
            this.outputMessagePanel1 = new Chisel.Editor.UI.DockPanels.OutputMessagePanel();
            this.DockRight = new Chisel.Editor.UI.DockedPanel();
            ...
            this.DocumentTabs.RequestClose += new Chisel.Editor.UI.ClosableTabControl.RequestCloseEventHandler(this.DocumentTabsRequestClose);
