...
namespace Chisel.Editor.Extensions
{
    public static class ModelExtensions
    {
        ...
        {
            if (Chisel.Settings.View.DisableModelRendering) return false;
        ...
        {
            return HasModel(entity) ? Chisel.Settings.View.ModelRenderDistance : int.MaxValue;
        }
    }
}
