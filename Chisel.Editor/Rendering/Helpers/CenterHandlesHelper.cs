...
namespace Chisel.Editor.Rendering.Helpers
{
    public class CenterHandlesHelper : IHelper
    {
        ...
        public bool Is2DHelper { get { return Chisel.Settings.Select.DrawCenterHandles; } }
        ...
        {
            if (Chisel.Settings.Select.CenterHandlesActiveViewportOnly && !viewport.IsFocused) return;
            var center = viewport.Flatten(o.BoundingBox.Center);
            double a = 192;
            if (Chisel.Settings.Select.CenterHandlesFollowCursor)
            {
