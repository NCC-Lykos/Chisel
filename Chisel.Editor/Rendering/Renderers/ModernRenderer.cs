...
using Chisel.Editor.Rendering.Arrays;
using Chisel.Editor.Rendering.Shaders;
...
namespace Chisel.Editor.Rendering.Renderers
{
    public class ModernRenderer : IRenderer
    {
        ...
        public void Draw2D(ViewportBase context, Matrix4 viewport, Matrix4 camera, Matrix4 modelView)
        {
            ...
            if (Chisel.Settings.View.Draw2DVertices)
            {
                if (Chisel.Settings.View.OverrideVertexColour)
                {
                    var c = Chisel.Settings.View.VertexOverrideColour;
                    _mapObject2DShader.OverrideColour = new Vector4(c.R / 255f, c.G / 255f, c.B / 255f, 1);
                }
                _array.RenderVertices(context.Context, Chisel.Settings.View.VertexPointSize);
        ...
        public void Draw3D(ViewportBase context, Matrix4 viewport, Matrix4 camera, Matrix4 modelView)
        {
            ...
            if (!opts.Wireframe)
            {
                ...
                if (!Chisel.Settings.View.DisableModelRendering)
                {
