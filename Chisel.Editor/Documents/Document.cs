...
using Chisel.Editor.Editing;
using Chisel.Editor.Environment;
using Chisel.Editor.Extensions;
using Chisel.Editor.History;
using Chisel.Editor.Rendering;
using Chisel.Editor.Rendering.Helpers;
...
namespace Chisel.Editor.Documents
{
    public class Document
    {
        ...
        {
            if (!Chisel.Settings.View.KeepSelectedTool) ToolManager.Activate(_memory.SelectedTool);
            if (!Chisel.Settings.View.KeepCameraPositions) _memory.RestoreViewports(ViewportManager.Viewports);
        ...
        {
            if (!Chisel.Settings.View.KeepSelectedTool && ToolManager.ActiveTool != null) _memory.SelectedTool = ToolManager.ActiveTool.GetType();
            if (!Chisel.Settings.View.KeepCameraPositions) _memory.RememberViewports(ViewportManager.Viewports);
