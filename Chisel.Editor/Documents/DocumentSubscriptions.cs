...
using Chisel.Editor.Actions.MapObjects.Groups;
...
namespace Chisel.Editor.Documents
{
    ...
    public class DocumentSubscriptions : IMediatorListener
    {
        ...
        public void TieToEntity()
        {
            ...
            if (Chisel.Settings.Select.OpenObjectPropertiesWhenCreatingEntity && !ObjectPropertiesDialog.IsShowing)
            {
        ...
        public void ToggleShow3DGrid()
        {
            ...
            if (_document.Map.Show3DGrid && Chisel.Settings.View.Renderer != RenderMode.OpenGL3)
            {
