...
namespace Chisel.Editor.Menu
{
    public static class MenuManager
    {
        ...
        private static void AddDefault()
        {
            ...
            Add("Map", new SimpleMenuBuilder("Show 3D Grid", HotkeysMediator.ToggleShow3DGrid) { Image = Resources.Menu_Show3DGrid, IsVisible = mapOpen, IsChecked = () => mapOpen() && DocumentManager.CurrentDocument.Map.Show3DGrid, ShowInToolStrip = true, IsActive = () => Chisel.Settings.View.Renderer == RenderMode.OpenGL3 });
            ...
            Add("Help", new SimpleMenuBuilder("Online Help", EditorMediator.OpenWebsite, "http://Chisel-editor.com/") { Image = Resources.Menu_Help });
            Add("Help", new SimpleMenuBuilder("Chisel Website", EditorMediator.OpenWebsite, "http://Chisel-editor.com/") { Image = Resources.Menu_Website });
            Add("Help", new SimpleMenuBuilder("Chisel Community", EditorMediator.OpenWebsite, "http://Chisel-editor.com/") { Image = Resources.Menu_Community });
